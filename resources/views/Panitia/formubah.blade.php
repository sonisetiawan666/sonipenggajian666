    ...
    <div class="col-md-7">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form action="{{ URL::to('panitia/' . $panitia->id) }}" method="POST" class="form-horizontal" name="masterForm" class="form-validation">
            {{ csrf_field() }}
            {{method_field('PUT')}}
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-12">
                ...
                <a href="{{ URL::to('/panitia')}}" class="btn btn-warning" type="button">Cancel</a>
              </div>
            </div>
